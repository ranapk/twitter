      ...
      <div class="lg:w-full relative">
        ...
        >
          ...
          <div class="hidden lg:block ml-4">
            <p class="text-sm font-bold leading-tight">Prateek</p>
            <p class="text-sm leading-tight">@beingPatrick</p>
          </div>
    ...
    <div class="w-full md:w-1/2 h-full overflow-y-scroll">
      ...
      <div class="flex flex-col-reverse">
        ...
        >
          <div class="flex-none mr-4">
            <img src="prateek.jpg" class="h-12 w-12 rounded-full flex-none" />
          </div>
          <div class="w-full">
            <div class="flex items-center w-full">
              <p class="font-semibold">Prateek</p>
              <p class="text-sm text-dark ml-2">@beingPatirck</p>
      ...
      >
        ...
        <div class="w-full">
          ...
          <div v-if="follow.image !== null">
            <img src="banner.jpg" class="h-full w-full mb-3 flex-none" />
          </div>
          <div class="flex items-center justify-between w-full">
            <div class="flex items-center text-sm text-dark">
              <i class="far fa-comment mr-3"></i>
  ...
  data() {
    return {
      ...
      trending: [
        {
          top: "IPL 2020",
          title: "Kings XI Punjab beat Mumbai Indians in the second Super Over",
          bottom: "Trending with #SuperOver, rohit",
        },
        { top: "Covid-19", title: "Covid-19 in India", bottom: "" },
        ...
        { top: "Trending in India", title: "Taiwan", bottom: "25.4k tweets" },
      ],
      friends: [
        { src: "elon.jpg", name: "Elon Musk", handle: "@elonmusk" },
        { src: "monk.jpg", name: "Adrian Monk", handle: "@detective:)" },
        { src: "kevin.jpg", name: "Kevin Hart", handle: "@KevinHart4real" },
      ],
      following: [
        {
          src: "elon.jpg",
